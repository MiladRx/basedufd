...
const HomePage = () => {
  ...
  const handleCopy = () => {
    const contractAddress = '0x2CeA2655aD958a2cE3BA9E3001bd8059cfa8B1d0';
    navigator.clipboard.writeText(contractAddress)
      .then(() => {
        setCopySuccess('Contract address copied to clipboard!');
      })
      .catch((err) => {
  ...
  return (
    <div className="flex items-center justify-center h-screen overflow-x-hidden bg-[#000000]">
      <div className="flex flex-col items-center justify-center text-center px-4 sm:px-8 py-6 bg-opacity-80 w-full max-w-screen-lg">
        ...
        <div className="flex  -mt-36 justify-center">
          <img src="/img/sssssssssss.png" alt="Logo" className="w-[450px] h-[450px] sm:w-[250px] sm:h-[250px] md:w-[450px] md:h-[450px] object-contain" />
        </div>
        ...
        <div className="flex items-center space-x-2 mb-6 px-4 sm:px-8">
          <p id="contract-address" className="text-sm sm:text-3xl font-bold text-white truncate">
            0x8eaa9f179f965a670af292e57e06c1d091b0c533
          </p>
          <svg
            onClick={handleCopy}
        ...
        <div className="flex flex-wrap justify-center gap-5 mt-3">
          ...
          <a href="https://dexscreener.com/base/0x8eaa9f179f965a670af292e57e06c1d091b0c533" className="text-gray-400 hover:text-white flex items-center">
