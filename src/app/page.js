...
const HomePage = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen overflow-x-hidden bg-[#80CAFF]">
  ...
  Based Unicorn Fart Dust
        ...
        <div className="flex flex-wrap justify-center gap-5 mt-3">
          <a href="https://x.com/BasedUFDcto" className="text-gray-400 hover:text-white">
          ...
          <a href="https://t.me/basedunicornfartdust" className="text-gray-400 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 50 50">
